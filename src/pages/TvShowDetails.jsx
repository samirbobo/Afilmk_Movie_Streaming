...
import TvSeasonsAccording from "../components/TvSeasonsAccording";
...
const TvShowDetails = () => {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () =>
      axios.get(
        `${BASE_URL}/tv/${id}?api_key=${API_KEY}&append_to_response=videos,credits,reviews,recommendations,images`
      ),
